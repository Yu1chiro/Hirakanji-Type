      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          if (categorySelect.value === 'Kanji') {
            promptText = "Berikan teks \u8AAD\u89E3 singkat ".concat(lengthTextSelect.value, " bahasa Jepang acak dalam huruf kanji level ").concat(kanjiLevelSelect.value, ". Berikan hanya teks Jepang tanpa terjemahan atau penjelasan tambahan.");
          } else {
