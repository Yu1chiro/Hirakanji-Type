      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          if (categorySelect.value === 'Kanji') {
            promptText = "Berikan teks \u8AAD\u89E3  level JLPT ".concat(kanjiLevelSelect.value, " singkat ").concat(lengthTextSelect.value, " bahasa Jepang dalam bentuk hiragana. Berikan hanya teks Jepang tanpa terjemahan atau penjelasan tambahan.");
          } else {
